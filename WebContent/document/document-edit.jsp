...
<body>
<form class="layui-form" action="document/documentUpdate" enctype="multipart/form-data" method="post">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="documentTitle" lay-verify="required" lay-reqtext="文档标题不能为空"  value="${document.documentTitle}" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label required">文档描述</label>
        <div class="layui-input-inline">
            <textarea name="documentRemark" type="text/plain" style="width:99%;height:250px">${document.documentRemark}</textarea>
        </div>
    </div>
